...
<body>
    <form id="form1" runat="server">
        <div class="layui-card-body " style="width: auto; top: 5px;">
            ...
            <br />
            <br />
            <asp:GridView ID="GridView1" CssClass="layui-table layui-form" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" DataKeyNames="Id">
                <Columns>
                    <asp:BoundField HeaderText="编号" DataField="StudentId"/>
